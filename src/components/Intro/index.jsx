...
const Intro = () => {
  return (
    <>
      {/* fixed at top */}
      <div className='header z-50 absolute border-b-2 border-b-green-700 bg-green-700/15 backdrop-blur-sm inset-y-0 h-48 top-0 flex items-center justify-center w-full flex-col px-4 gap-y-4'>
        <img className='w-20 h-20 rounded-full' src={anoop} alt='profile picture' />
